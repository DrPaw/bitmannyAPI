                    ...
                    <div class="col-xl-12">
                        ...
                        @foreach($authWallets as $data)
                            <div class="col-xl-4 col-lg-6 col-md-6 col-6 text-white">
                                <div class="widget-card" style="background-colo: {{binanceyellow()}}">
                                    <div class="widget-title">
                                        <h5 class="text-whites">@if($data->type == 'deposit_wallet') Fiat Balance @elseif($data->type == 'interest_wallet') Stake PNL @elseif($data->type == 'hodl_wallet')  Stake PNL @endif</h5>

                                    </div>
                                    <div class="widget-info">
                                        <h3 class="text-whites"><small class="text-whites">{{$general->cur_sym}}</small>{{number_format($data->balance,2)}}</h3>
                                    ...
                                    <ul class="list-unstyled">
                                     @foreach($currency as $data)
                                            @php $wallet = App\Cryptowallet::whereCoinId($data->id)->where('user_id', auth()->id())->whereStatus(1)->first(); @endphp
                                             <li class="d-flex">
                                            <img src="{{url('/')}}/back/images/crypto-currencies/round-outline/{{$data->image}}" width="40">
