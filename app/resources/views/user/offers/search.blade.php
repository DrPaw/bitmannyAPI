							...
							<div class="col-md-12">
								<div class=" pt-0  cover-image pt-7 bg-background2 card pb-7 bg-primary border-0" data-image-src="../assets/images/banners/banner5.jpg">
									<div class="header-text mb-0">
										<div class="container">
											<div class="text-center text-white background-text"><br>
												<h2 class="mb-2 display6">P2P Sell Offers Market</h2>
												<p>Please select the cryptocurrency you wish to buy and your country.
											...
											<div class="row">
												...
												<div class="col-xl-11 col-lg-12 col-md-12 d-block mx-auto">
													...
													<div class="text-center background-text">
														<button type="submit" class="btn btn-info btn-lg pl-6 pr-6 pt-2 pb-2 mx-auto"> <li class="fa fa-search"></li> &nbsp;FIND SELL OFFER</button>
													</div>
													<br><br>
												</div>
