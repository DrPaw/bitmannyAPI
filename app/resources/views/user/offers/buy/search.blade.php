...
<!-- Row-->
  <form  action="{{route('user.searchp2pbuy')}}" method="post" enctype="multipart/form-data">
                                       @csrf
									...
									<div class="header-text mb-0">
										<div class="container">
											<div class="text-center text-white background-text">
												<h2 class="mb-2 display6">P2P Buy Offers</h2>
												<p>Please select the cryptocurrency you wish to sell and your preferred country of trade.
												We will filter your search with the best result of cryptocurrency buy offers<br>
											...
											<div class="row">
												...
												<div class="col-xl-11 col-lg-12 col-md-12 d-block mx-auto">
															...
															<div class="form row mx-auto justify-content-center d-flex">
																<div class="form-group col-xl-4 col-lg-4  col-md-12 mb-0">
																	<select name="currency" class="form-control select2-show-search  custom-select">
																		<option disabled selected  >Select The Crypto You Want To Sell</option>
													...
													<div class="text-center background-text">
														<button type="submit"  style="background-color: {{$general->bclr}}" class="btn btn-pink btn-lg pl-6 pr-6 pt-2 pb-2 mx-auto"> <li class="fa fa-search"></li> &nbsp;FIND BUY OFFER</button>
													</div>
												</div>
