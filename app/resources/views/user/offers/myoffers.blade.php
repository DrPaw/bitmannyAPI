...
<div class="content-body">
											...
											<table id="exampleu" class="table table-striped table-bordered " >
												...
												@php $pend = App\Cryptotrade::whereMarketcode($data->code)->whereStatus(0)->count(); @endphp
													<tr>
														...
														@if($data->status < 1)
														<td><span class="badge badge-danger badge-md">Inactive</span></td>
														@else
														<td><span class="badge badge-success badge-md">Active</span></td>
														@endif
														<td>
                                                            @if($data->status > 0)
															<a href="{{route('user.disableoffer',$data->code)}}"  class="btn btn-warning btn-sm mb-2 mb-xl-0 text-white" data-toggle="tooltip" data-original-title="Disable Offer"><i class="fa fa-close"></i></a>
															@else
															<a  href="{{route('user.deleteoffer',$data->code)}}"  class="btn btn-danger btn-sm mb-2 mb-xl-0 text-white" data-toggle="tooltip" data-original-title="Delete Offer"><i class="fa fa-trash-o"></i></a>
			...
			<div class="d-flex">
				...
				<div class="">
					...
					<a href="{{route('user.createselloffer')}}" class="btn btn-primary mx-1" href="#">Create Offer </a>
				</div>
			</div>
		</div>
