											...
											<table id="example" class="table table-striped table-bordered " >
												...
												@foreach($offer as $data)
													<tr>
														...
														<td>${{number_format($data->min,2)}} <br>
														...
														<td>
															<a href="{{ route('admin.view.offerbuy' , $data->code) }}"  class="btn btn-info btn-sm mb-2 mb-xl-0 text-white" data-toggle="tooltip" data-original-title="View"><i class="fa fa-eye"></i> &nbsp; View</a>
														</td>
													</tr>
												@endforeach
