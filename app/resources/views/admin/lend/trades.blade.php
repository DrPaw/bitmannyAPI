													...
													<tbody>
													 @foreach($trx as $data)
														...
														<td>
															...
															<a href="{{route('admin.tradechatbuy',$data->trx)}}" class="btn btn-info btn-sm text-white" data-toggle="tooltip" data-original-title="View Chat"><i class="fa fa-envelope"></i></a>
															<a href="{{ route('admin.view.offerbuy' , $data->marketcode) }}"  class="btn btn-primary btn-sm text-white" target="_blank" data-toggle="tooltip" data-original-title="View Offer"><i class="fa fa-eye"></i></a>
													...
													<div class="modal-content border-0">
														<div class="modal-body text-center">
															...
															<div class="py-3 text-center">
																<h3>Approve Trade</h3>
																<p>Are you sure you want to approve this trade?<br> Please ensure you have verified this Escrow transaction be double sure by checking the invoice using the escrow ID as the invoice number on your account with coinremitter.com. You can the proceed to send coin to buyer's wallet and approve transaction<br>
																<!--This cannot be undone!! --></p>
																<a href="{{route('admin.tradeapprovebuy',$data->trx)}}"  style="background-color: {{$general->bclr}}" class="btn btn-primary">Approve Trade</a>
															</div>
														</div>
													...
													<div class="modal-content border-0">
														<div class="modal-body text-center">
															...
															<div class="py-3 text-center">
																...
																This cannot be undone!!</p>
																<a href="{{route('admin.tradedeletebuy',$data->trx)}}" "{{url('/')}}/admin/trade-deleted/{{$data->trx}}"  style="background-color: {{$general->bclr}}" class="btn btn-primary">Delete Trade</a>
															</div>
														</div>
													...
													<div class="modal-content border-0">
														<div class="modal-body text-center">
															...
															<div class="py-3 text-center">
																...
																This cannot be undone!!</p>
																<a href="{{route('admin.canceldisputebuy',$data->trx)}}"  style="background-color: {{$general->bclr}}" class="btn btn-primary">Approve Trade</a>
															</div>
														</div>
