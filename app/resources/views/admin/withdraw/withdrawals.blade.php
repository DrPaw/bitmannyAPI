...
<div class="row">
                        ...
                        @php $bank = $withdraw->detail; @endphp
                        <tr>
                            ...
                            <td class="budget">{{ formatter_money($withdraw->rate * $payable) }} {{ $withdraw->currency }} </td>
                            @if(request()->routeIs('admin.withdraw.pending'))
                            <td>
                                ...
                                <button class="btn btn-success approveBtn" data-prove_img="@php echo $proveImg @endphp" data-detail="{{$bank}}"  data-id="{{ $withdraw->id }}" data-amount="{{ formatter_money($withdraw->amount) }} {{ $withdraw->currency }}" data-username="{{ $withdraw->user->username }}"><i class="fa fa-fw fa-check"></i></button>
                                <button class="btn btn-danger rejectBtn" data-prove_img="@php echo $proveImg @endphp" data-detail="{{$bank}}"  data-id="{{ $withdraw->id }}" data-amount="{{ formatter_money($withdraw->amount)}} {{ $withdraw->currency }}" data-username="{{ $withdraw->user->username }}"><i class="fa fa-fw fa-ban"></i></button>
...
<script>
    $('.approveBtn').on('click', function() {
        ...
        modal.find('.withdraw-detail').html(details);
