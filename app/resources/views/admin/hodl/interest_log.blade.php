...
@section('content')
  ...
  <!-- Banner opened -->
								...
								<div class="card-body p-4 text-white">
									<div class="row">
										<div class="col-xl-8 col-lg-12 col-md-12">
											<div class="d-sm-flex">
												 <div class="ml-4">
													<h4 class="text-uppercase mb-0 mt-1">Active HODL: {{$general->cur_sym}}{{formatter_money(App\Hodltrx::whereStatus(1)->sum('amount'))}}</h4>
													<h4 class="text-uppercase mb-0 mt-1">Closed HODL: {{$general->cur_sym}}{{formatter_money(App\Hodltrx::whereStatus(0)->sum('amount'))}}</h4>
                    ...
                    @endphp
                                    ...
                                    <td data-label="@lang('Plan Name')">{{__(App\User::whereId($data->user_id)->first()->username ?? "N/A")}}</td>
                                    <td data-label="@lang('Plan Name')">{{__(App\Hodl::whereId($data->plan_id)->first()->name ?? "N/A")}}</td>
