							...
							<div class="col-xs-12 col-lg-12 col-xl-12">
								<div class="card">
									<div class="section-title center-block text-center mt-6">
										<h3>Crypto HODL Plans</h3>
										<p>Click on the button below to create a new HODL Plan</p>
									</div>
									<div class="pricing-tabs">
										<div class=" text-center">
											<div class="pri-tabs-heading">
												<ul class="nav nav-price">
													<li><a class="active show"  href="{{route('admin.hodl-create')}}" >Create New HODL Plan</a></li>
												</ul>
											</div>
												...
												<div class="tab-pane active show pb-0" id="year" >
                                                    ...
                                                    % @else {{$general->cur_text}} @endif</div>
																	<ul class="list-unstyled leading-loose">
																		<li><i class="fa fa-check mr-2 text-primary"></i>Yield After {{$data->times}} Hours</li>
																	...
																	<div class="text-center m-4">
																		<a href="{{route('admin.hodl-edit',$data->id)}}" class="btn btn-primary btn-block">Edit Plan</a>
																	</div>
																</div>
															</div>
														</div>
