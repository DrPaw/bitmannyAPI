...
<!-- row opened -->
							...
							<div class="col-12">
								...
								<div class="card">
									<div class="card-header">
										<div class="card-title">Create New HODL Plan</div>
										...
										<div class="row">
											<div class="col-lg-6 col-xl-12 col-md-12 col-sm-12">
												<div class="card  box-shadow-0">
													<div class="card-header">
														<h4 class="card-title">Create New HODL Plan</h4>
													</div>
													<div class="card-body">
														 <form method="post" class="form-horizontal" action="{{route('admin.hodl-store')}}">
                        @csrf
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="form-control select" name="times">
                                        @foreach($time as $data)
                                            <option value="{{$data->time}}">{{$data->name}} (1 {{$data->slug}})</option>
                                        @endforeach
                                    </select>
                                </div>
                        ...
                        <div class="col-md-12">
                            ...
                            <button type="submit" class="btn btn-primary btn-block">CREATE HODL PLAN</button>
