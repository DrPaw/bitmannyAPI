...
class WalletController extends Controller
{
    ...
    public function wallet($id)
    {
        ...
        return view('user.wallets.wallet', compact('trx','page_title','currency','wallets','unit','rate','usd'));
      }
      ...
      public function swapcoin()
    {
        ...
        GetCoinPrice();
        return view('user.trade.swap', compact('page_title','currency','wallets','trade'));
    }
       ...
       //return $getunit;
        ...
        if ($totalunit > $fromwallet->balance) {
            ...
            $result = Cryptotrx::create($w);
             ...
             $notify[] = ['success', 'Your Coin Swap was succcessful'];
            return back()->withNotify($notify);
        }
    }
