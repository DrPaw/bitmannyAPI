...
Route::get('/vault', 'CronController@vault');
Route::get('/hodl', 'CronController@hodl');
Route::get('/coinrate', 'CronController@coinrate');
Route::get('/coinratehome', 'CronController@coinratehome');
...
Route::name('user.')->prefix('user')->group(function () {
    ...
    Route::middleware('auth')->group(function () {
        ...
        Route::middleware('ckstatus')->group(function () {
            ...
            //Sell Market Offers
            Route::get('create-sell-offer','OfferController@create')->name('createselloffer');
            ...
            Route::get('activate-offer/{id}','OfferController@activateoffer')->name('activateoffer');
            ...
            Route::post('rateseller/{id}', 'OfferController@rateseller')->name('rateseller');


             //Buy Market Offers
            Route::get('create-buy-offer','OfferController@createbuy')->name('createbuyoffer');
            Route::get('create-offer-step2-buy/{id}','OfferController@createoffer2buy')->name('createoffer2buy');
            Route::post('post-offer-buy/{id}','OfferController@postofferbuy')->name('postofferbuy');
            Route::get('my-offers-buy','OfferController@myoffersbuy')->name('myoffersbuy');
            Route::get('p2p-buy-offers','OfferController@p2pbuy')->name('p2pbuy');
            Route::get('p2p-buy-trades','OfferController@p2plogbuy')->name('p2plogbuy');

            Route::get('delete-offers-buy/{id}','OfferController@deleteofferbuy')->name('deleteofferbuy');
            Route::get('disable-offers-buy/{id}','OfferController@disableofferbuy')->name('disableofferbuy');
            Route::get('activate-offers/{id}','OfferController@activateofferbuy')->name('activateofferbuy');
            Route::get('manage-offers-buy/{id}','OfferController@manageofferbuy')->name('manageofferbuy');
            Route::post('p2p-search-buy','OfferController@searchp2pbuy')->name('searchp2pbuy');
            Route::get('marketbuy','OfferController@marketbuy')->name('marketbuy');
            Route::get('view-offer-buy/{id}','OfferController@viewofferbuy')->name('viewofferbuy');
            Route::post('contact-seller-buy/{id}','OfferController@contactsellerbuy')->name('contactsellerbuy');
            Route::get('chat-buyer-buy/{id}','OfferController@chatbuyerbuy')->name('chatbuyerbuy');
            Route::post('reply-buyer-buy','OfferController@replychatbuyerbuy')->name('replychatbuyerbuy');
            Route::get('escrowpaid-seller-buy/{id}','OfferController@escrowpaidbuy')->name('escrowpaidbuy');
            Route::get('chat-seller-buy/{id}','OfferController@chatsellerbuy')->name('contactbuyerbuy');
            Route::post('reply-seller-buy','OfferController@replychatsellerbuy')->name('replychatsellerbuy');
            Route::get('trade-paid-buy/{id}','OfferController@tradepaidbuy')->name('tradepaidbuy');
            Route::get('trade-approve-buy/{id}','OfferController@tradeapprovebuy')->name('tradeapprovebuy');
            Route::get('chat-history-buy/{id}','OfferController@chathistorybuy')->name('chathistorybuy');
            Route::get('trade-dispute-buy/{id}','OfferController@tradedisputebuy')->name('tradedisputebuy');
            Route::get('close-dispute-buy/{id}','OfferController@closedisputebuy')->name('closedisputebuy');
            Route::post('rateseller-buy/{id}', 'OfferController@ratesellerbuy')->name('ratesellerbuy');


            //Lend Controller
            Route::get('create/lend', 'LendController@newlend')->name('newlend');
            Route::get('create/lend/{id}', 'LendController@createofferlend')->name('createofferlend');
            Route::post('create/lend/{id}', 'LendController@createlendpost');
            Route::get('lend/offers', 'LendController@mylendoffers')->name('mylendoffers');
            Route::get('delete-offers-lend/{id}','LendController@deleteofferlend')->name('deleteofferlend');
            Route::get('disable-offers-lend/{id}','LendController@disableofferlend')->name('disableofferlend');
            Route::get('activate-offers-lend/{id}','LendController@activateofferlend')->name('activateofferlend');
            Route::get('manage-offers-lend/{id}','LendController@manageofferlend')->name('manageofferlend');
            Route::get('lend-offers/borrow','LendController@borrowcrypto')->name('borrowcrypto');
            Route::post('lend-offers/search','LendController@searchp2plend')->name('searchp2plend');
            Route::get('lend-offers/result','LendController@lendmarket')->name('lendmarket');
            Route::get('lend-offers/view/{id}','LendController@viewlenderoffer')->name('viewlenderoffer');
            Route::post('lend-offers/contact/{id}','LendController@contactlender')->name('contactlendersell');
            Route::get('chat-borrower-lend','LendController@chatbuyerlend')->name('chatbuyerlend');
            Route::get('lend-offers/approve/{id}','LendController@loanapprove')->name('loanapprove');
            Route::get('lend-offers/dispute/{id}','LendController@loandispute')->name('loandispute');
            Route::get('chat-lender/{id}','LendController@chatlender')->name('chatborrower');
            Route::get('escrow-lender/{id}','LendController@escrowpaidlend')->name('escrowpaidlend');
            Route::get('colla-paid/{id}','LendController@colateralpaid')->name('colateralpaid');
            Route::post('reply-borrower/lend','LendController@replychatbuyerlend')->name('replychatbuyerlend');
            Route::post('reply-lender/lend','LendController@replychatsellerlend')->name('replychatsellerlend');
            Route::get('borrowing-log','LendController@borrowinglog')->name('borrowinglog');
            Route::get('close-lend-dispute/{id}','LendController@closeloandispute')->name('closeloandispute');
            Route::get('chat-lend-history/{id}','LendController@lendchathistory')->name('lendchathistory');
            ...
            // Deposit Crypto
            Route::get('depositcrypto', 'Gateway\PaymentController@depositcrypto')->name('depositcrypto');
            Route::post('depositcrypto', 'Gateway\PaymentController@depositcryptopost');
            Route::get('deposit/crypto', 'Gateway\PaymentController@sendcrypto')->name('deposit.crypto');
            Route::get('verifypay/{id}', 'Gateway\PaymentController@verifypay')->name('verifypay');
            ...
            //HODL PLANS
            Route::get('/hodl-plan', 'UserController@hodl')->name('hodl');
            Route::post('/hodl', 'UserController@buyhodl')->name('buy.hodl');
            Route::get('hodl/log', 'UserController@hodlLog')->name('hodl.log');
...
Route::namespace('Admin')->prefix('admin')->name('admin.')->group(function () {
    ...
    Route::middleware('admin')->group(function () {
        ...
        //Offer Controller
        Route::get('offer_all_buy', 'OfferSettingController@allofferbuy')->name('all.offerbuy');
        Route::get('offer_view_buy/{id}', 'OfferSettingController@viewofferbuy')->name('view.offerbuy');
        Route::get('trade_allbuy/{id}', 'OfferSettingController@alltradebuy')->name('alltrx.offerbuy');
        Route::get('trade_successbuy/{id}', 'OfferSettingController@successtradebuy')->name('success.offerbuy');
        Route::get('trade_pendingbuy/{id}', 'OfferSettingController@pendingtradebuy')->name('pending.offerbuy');
        Route::get('trade_disputebuy/{id}', 'OfferSettingController@disputetradebuy')->name('dispute.offerbuy');
        Route::get('trade_paidbuy/{id}', 'OfferSettingController@paidradebuy')->name('paid.offerbuy');
        Route::get('trade_disputedbuy/{id}', 'OfferSettingController@disputedtradebuy')->name('disputed.offerbuy');
        Route::get('deactivateofferbuy/{id}', 'OfferSettingController@deactivateofferbuy')->name('deactivate.offerbuy');
        Route::get('activateofferbuy/{id}', 'OfferSettingController@activateofferbuy')->name('activate.offerbuy');
        Route::get('trade-deletebuy/{id}','OfferSettingController@tradedeletebuy')->name('tradedeletebuy');
        Route::get('trade_chatbuy/{id}', 'OfferSettingController@tradechatbuy')->name('tradechatbuy');
        Route::get('trade_approvebuy/{id}', 'OfferSettingController@tradeapprovebuy')->name('tradeapprovebuy');
        Route::get('trade_cancel_disputebuy/{id}', 'OfferSettingController@canceldisputebuy')->name('canceldisputebuy');


        Route::get('awaiting_offer_viewbuy/{id}', 'OfferSettingController@awaitingofferviewbuy')->name('view.awaiting.offerbuy');
        Route::get('awaitingofferbuy', 'OfferSettingController@awaitingbuy')->name('awaiting.offerbuy');
        Route::get('successful_offer_viewbuy/{id}', 'OfferSettingController@successfulofferviewbuy')->name('view.successful.offerbuy');
        Route::get('pendingofferbuy', 'OfferSettingController@pendingcbuy')->name('pending.offerbuy');
        Route::get('pending_offer_viewbuy/{id}', 'OfferSettingController@pendingofferviewbuy')->name('view.pending.offerbuy');
        Route::get('declinedofferbuy', 'OfferSettingController@declinedcbuy')->name('declined.offerbuy');
        Route::get('disputed_offer_viewbuy/{id}', 'OfferSettingController@declinedofferviewbuy')->name('view.declined.offerbuy');
        ...
        //Loan Controller
        Route::get('pendingloan', 'LoanSettingController@pendingloan')->name('pendingloan');
        Route::get('view-offer-lend/{id}', 'LoanSettingController@viewofferlend')->name('viewofferlend');
        Route::get('all-offer-lend/{id}', 'LoanSettingController@allofferlend')->name('allofferlend');
        ...
        Route::get('closed-plan', 'PlanController@closed')->name('plan-closed');
         ...
         // HODL Controller
        Route::get('hodl-setting', 'HodlSettingController@index')->name('hodl-setting');
        Route::get('hodl-setting/edit/{id}', 'HodlSettingController@edit')->name('hodl-edit');
        Route::get('hodl-setting/create', 'HodlSettingController@create')->name('hodl-create');
        Route::post('hodl-setting/create', 'HodlSettingController@store')->name('hodl-store');
        Route::put('hodl-setting/update/{id}', 'HodlSettingController@update')->name('hodl-update');
        Route::get('running-hodl', 'HodlSettingController@runninghodl')->name('hodl-running');
        Route::get('closed-hodl', 'HodlSettingController@closedhodl')->name('hodl-closed');
