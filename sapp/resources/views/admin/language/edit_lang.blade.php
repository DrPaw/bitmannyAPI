									...
									<div class="card card-custom gutter-b bg-transparent shadow-none border-0" >
										<div class="card-header align-items-center   border-bottom-dark px-0">
											<div class="card-title mb-0">
												<h3 class="card-label mb-0 font-weight-bold text-body">{{$page_title}}
												</h3>
											</div>
                ...
                <div class="tile-body" style="overflow: hidden">
                    <form method="post" action="{{route('admin.setting.key-update', $la->id)}}" id="langForm">
                        ...
                        <div class="form-body">
                            ...
                            <br>
                                 <button class="btn btn-success btn-block" data-toggle="tooltip" title="Save" @click.prevent="save">Update Translation</button>
                        ...
                        <div class="card-footer">
                            ...
                            <div class="col-12">
                            <small>Enter The transalation in English and {{$la->name}}, then click on the "Add Translation" button then click on the "Update" button when done
                             <form id="newlangForm">
                    ...
                    <div class="modal-footer">
                        <input type="submit" class="btn btn-primary"  value="Add Translation" @click.prevent="addfield()">
                    </div>
                    </form>
                              </div>
