								...
								<div class="card">
									<div class="card-header border-bottom-0 online-status d-flex justify-content-between align-items-center">
										...
										@if($my_ticket->status == 0)
                                               <div class="status offline "> <h6 class="online text-right"> @lang("Open")</h6>
                                            ...
                                            @elseif($my_ticket->status == 3)
                                                <div class="status offline "> <h6 class="online text-right"> @lang("Close")</h6>
                                            @endif
								...
								<div class="card">
									...
									<div class="card-footer d-sm-flex">
										...
										<div class="btn-list ml-auto">
											...
											<button type="submit" value="1" name="replayTicket" class="btn btn-primary btn-space"><i class="fe fe-send text-white "></i> &nbsp; @lang("Confirm")</button>
										</div>
									</div>
									</form>
									@endif
