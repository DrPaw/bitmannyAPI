...
<!-- App-content opened -->
            ...
            <div class="container">
                <div class="row">
								<div class="col-lg-12 col-xl-12 col-md-12 col-sm-12">
									...
									<div class="card">
										<div class="card-header">
											<h3 class="@if(Auth::user()->darkmode != 0) text-white @endif">Recently Referred</h3>
										</div>
                            ...
                            @else
                                <tr>
                                    <td colspan="4 bg-warning"> @lang('No Referral Log Found')!</td>
                                </tr>
                            @endif
						...
						<div class="row">
							<div class="col-md-12 col-lg-12">
								<div class="card">
									<div class="card-header">
										<div class="@if(Auth::user()->darkmode != 0) text-white @endif">Referral Commission</div>
