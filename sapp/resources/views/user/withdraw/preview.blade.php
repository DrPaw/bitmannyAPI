							...
							<div class="col-md-12">
								<div class="card">
									...
									<div class="card-body">
                                        ...
                                        <div class="form-group">
                                            <label>{{__($withdraw->method->name)}} Account Details </label>
                                            <input type="text" name="detail" required  class="form-control " placeholder="" >
                                        </div>
                                    ...
                                    @endforeach
											<button type="submit" class="btn btn-success mt-2 float-right">Continue</button>
										</form>
