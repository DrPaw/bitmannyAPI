  ...
  let birthday = "{{$trade->expire}}",
    ...
    @endif
		...
		@endif
                                    ...
                                    <form role="form" method="POST"   action="{{route('user.replychatbuyerbuy')}}">
									 {{ csrf_field() }}
													...
													<div class="modal-content border-0">
														<div class="modal-body text-center">
															...
															<div class="py-3 text-center">
																...
																<a href="{{route('user.tradepaidbuy',$trade->trx)}}"  style="background-color: {{$general->bclr}}" class="btn btn-primary">Yes I Paid</a>
															</div>
														</div>
