													...
													<tr>
														...
														<td>
															<a  data-toggle="modal" data-target="#modal-approve" class="btn btn-success btn-sm text-white" data-toggle="tooltip" data-original-title="Approve Trade"><i class="fa fa-check"></i></a>
																<a href="{{route('user.chatbuyerbuy',$data->trx)}}" class="btn btn-info btn-sm text-white" data-toggle="tooltip" data-original-title="Chat With Buyer"><i class="fa fa-envelope"></i></a>
														</td>
													</tr>
