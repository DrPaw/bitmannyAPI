...
###########################################################################################
    ...
    {
        $page_title = 'Pending Loan Offers';
        $offer = Lendoffer::whereStatus(1)->get();
        return view('admin.lend.offer', compact('page_title','offer'));
    }

       public function viewofferlend($id)
    {

        $data['offer'] = Lendoffer::whereCode($id)->orderBy('id','desc')->first();
         if(! $data['offer']){
        ...
        return view('admin.lend.view-offer', $data);
    }

      public function allofferlend($id)
    {

        $data['offer'] = Lendoffer::whereCode($id)->first();
        if(!$data['offer']){
        $notify[] = ['error', 'We cant find lend offer'];
        return back()->withNotify($notify)->withInput();
        }
        $data['trx'] = Lendtrade::whereMarketcode($id)->get();
        $data['usd'] = Lendtrade::whereMarketcode($id)->sum('amount');
        $data['unit'] = Lendtrade::whereMarketcode($id)->sum('units');
        $data['count'] = Lendtrade::whereMarketcode($id)->count();
        $data['get'] = Lendtrade::whereMarketcode($id)->count();
         if($data['get'] < 1){
        $data['get'] = 1;
        }
        $data['page_title'] = "All Lending Offers";
        return view('admin.lend.trades', $data);


    }


  public function successfultradebuy($id)
    {

        $data['offer'] = Cryptoffer::whereCode($id)->whereType(2)->first();
        if(!$data['offer']){
        ...
        $data['page_title'] = "Successful Buy Trades";
        return view('admin.offer.buy.trades', $data);


    }

    public function disputedtradebuy($id)
    {
   ...
   public function pendingtradebuy($id)
    {
        ...
        $data['page_title'] = "Pending Buy Trades";
        return view('admin.offer.buy.trades', $data);


    }

     public function paidtradebuy($id)
    {
        ...
        $data['page_title'] = "User Paid Buy Trades";
        return view('admin.offer.buy.trades', $data);
          ...
          public function tradeapprovebuy($id)
    {
        ...
        return back()->withNotify($notify)->withInput();
         ...
         public function tradedeletebuy($id)
    {
        $trade = Cryptotrade::where('trx', $id)->orderBy('id','desc')->first();
        $escrow = Cryptoescrow::whereTrade_code($trade->trx)->orderBy('id','desc')->first();
        ...
        return back()->withNotify($notify)->withInput();
         ...
         public function canceldisputebuy($id)
    {
        $trade = Cryptotrade::where('trx', $id)->orderBy('id','desc')->first();
        $wallet = Cryptowallet::whereId($trade->wallet)->orderBy('id','desc')->first();
       ...
       public function tradechatbuy($id)
    {
        $trx = $id;
        ...
        return view('admin.offer.chat', $data);
         ...
         public function deactivateofferbuy($id)
    {
        $offer = Cryptoffer::where('code', $id)->whereType(2)->orderBy('id','desc')->first();
        if(! $offer){
        $notify[] = ['error', 'Invalid market trade'];
        return back()->withNotify($notify)->withInput();
        }
         ...
         public function activateofferbuy($id)
    {
     ...
     public function successfulcbuy()
    {
        $page_title = 'Select Currency';
        $coin = Currency::all();
        return view('admin.offer.buy.successful', compact('page_title','coin'));
    }


     public function successfulofferviewbuy($id)
    {

        $data['offer'] = Cryptoffer::whereCoin_id($id)->whereType(2)->first();
        if(!$data['offer']){
     ...
     public function awaitingbuy()
    {
        $page_title = 'Select Currency';
        $coin = Currency::all();
        return view('admin.offer.buy,awaiting', compact('page_title','coin'));
    }

      public function awaitingofferviewbuy($id)
    {
    ...
    public function pendingcbuy()
    {
        $page_title = 'Select Currency';
        $coin = Currency::all();
        return view('admin.offer.buy.pending', compact('page_title','coin'));
    }



     public function pendingofferviewbuy($id)
    {
     ...
     public function declinedcbuy()
    {
        $page_title = 'Select Currency';
        $coin = Currency::all();
        return view('admin.offer.buy,disputed', compact('page_title','coin'));
    }

      public function declinedofferviewbuy($id)
    {
    ...
    {
        $page_title = 'All Sell Offers';
        $offer = Cryptoffer::whereType(1)->get();
      ...
      public function viewoffer($id)
    {
        ...
        $data['offer'] = Cryptoffer::whereCode($id)->whereType(1)->orderBy('id','desc')->first();
         if(! $data['offer']){
        $notify[] = ['error', 'Invalid market offer'];
        return back()->withNotify($notify)->withInput();
        }
      ...
      public function alltrade($id)
    {
        ...
        $data['offer'] = Cryptoffer::whereCode($id)->whereType(1)->first();
        if(!$data['offer']){
