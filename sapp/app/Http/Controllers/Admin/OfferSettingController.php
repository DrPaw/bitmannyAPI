...
###########################################################################################
    ...
    public function allofferbuy()
    {
        $page_title = 'All Buy Offers';
        $offer = Cryptoffer::whereType(2)->get();
        return view('admin.offer.buy.offer', compact('page_title','offer'));
    }

       public function viewofferbuy($id)
    {

        $data['offer'] = Cryptoffer::whereCode($id)->whereType(2)->orderBy('id','desc')->first();
         if(! $data['offer']){
        ...
        return view('admin.offer.buy.view-offer', $data);
    }

      public function alltradebuy($id)
    {
        ...
        $data['page_title'] = "All Buy Trades";
