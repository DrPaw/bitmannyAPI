...
(14, 6, 'H4GBMEAGDRU7', 'RDKn5ncjjWyB7hrFQiUtdG', '5.05000000', '5.05000000', '1', '5.05000000', NULL, 16, 1, '2021-06-16 16:42:22', '2021-06-16 17:27:42');
...
(60, 16, 16, 4, 'This guy is just too good to trade with', 'KGPQAKU5COMH', NULL, 0, '2021-06-16 17:39:29', '2021-06-16 17:39:29');
...
(18, 16, 16, 'Hi, i want to borrow Test Coin worth of 2 USD', 'EY4WT3HZSQDN', 'WXWAKA5UC1PW', 1, '2021-06-29 14:37:24', '2021-06-29 14:37:24'),
(19, 16, 16, 'Hi, i want to borrow Test Coin worth of 50 USD', 'HPBDC34TK8TK', 'WXWAKA5UC1PW', 1, '2021-06-29 14:43:36', '2021-06-29 14:43:36'),
(20, 16, 16, 'Hi, i want to borrow Test Coin worth of 50 USD', 'HZOVO8NZDAGA', 'WXWAKA5UC1PW', 1, '2021-06-29 14:44:57', '2021-06-29 14:44:57'),
(21, 16, 16, 'Hi, i want to borrow 1.2Test Coin', 'H4GBMEAGDRU7', 'WXWAKA5UC1PW', 1, '2021-06-29 15:35:53', '2021-06-29 15:35:53'),
(22, 16, 16, 'Hello', 'H4GBMEAGDRU7', 'WXWAKA5UC1PW', 1, '2021-06-29 15:56:18', '2021-06-29 15:56:18'),
(23, 16, 16, 'okay', 'H4GBMEAGDRU7', 'WXWAKA5UC1PW', 2, '2021-06-29 15:59:00', '2021-06-29 15:59:00');
...
(1, 'Ethereum', 'ETH', 'sign-eth-alt', NULL, NULL, '2226.07', '1', '400', '435', 1, 1000000000, 'Ethereum.svg', 1, 1, 1, 1, 1, 1, '2021-01-15 05:14:00', '2018-02-15 05:36:57', '2021-06-29 22:14:20'),
(2, 'Bitcoin', 'BTC', 'sign-eth-alt', NULL, NULL, '36372', '1', '400', '435', 10, 2147483647, 'Bitcoin.svg', 1, 1, 1, 1, 1, 1, '2021-01-15 05:14:00', '2018-02-15 05:36:57', '2021-06-29 22:14:20'),
(3, 'Bitcoin Cash', 'BCH', 'sign-bch-alt', NULL, NULL, '535.17', '1', '390', '400', 100, 1000, 'Bitcoin.svg', 1, 1, 1, 1, 1, 1, '2021-01-15 05:13:29', '2018-02-15 05:36:57', '2021-06-29 22:14:20'),
(4, 'Litecoin', 'LTC', 'sign-ltc-alt', NULL, NULL, '148.26', '1', '370', '400', 100000, 100000, 'Litecoin.svg', 1, 1, 1, 1, 1, 1, '2021-01-15 05:13:25', '2018-02-15 05:36:57', '2021-06-29 22:14:20'),
(5, 'Dashcoin', 'DASH', NULL, NULL, NULL, '143.51', '1', '350', '350', 100000, 100000, 'Dash.svg', 1, 1, 1, 1, 1, 1, NULL, '2021-01-22 02:39:38', '2021-06-29 22:14:20'),
...
(11, 'USD Teter', 'USDT', 'sign-php-alt', NULL, NULL, '0.999869', '1', '465', '465', 100, 1000, 'Steem.svg', 1, 1, 1, 1, 1, 1, '2021-01-15 05:13:17', '2018-10-22 11:49:14', '2021-06-29 22:14:20'),
(118, 'Dogecoin', 'DOGE', NULL, NULL, NULL, '0.266572', '1', '350', '350', 100, 1000, 'Dash.svg', 1, 1, 1, 1, 1, 1, NULL, '2021-01-22 02:39:38', '2021-06-29 22:14:20');
...
--
-- Table structure for table `lend_offers`
--
...
CREATE TABLE `lend_offers` (
  ...
  `coin_id` int(11) NOT NULL,
  `code` varchar(88) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `wallet` varchar(22) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `min` varchar(200) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `max` varchar(88) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `user_id` int(11) NOT NULL,
  `rate` varchar(17) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `percent` varchar(88) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `mintime` int(88) DEFAULT NULL,
  `maxtime` int(88) DEFAULT NULL,
  `country` varchar(88) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `account` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `note` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `expire` varchar(88) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Dumping data for table `lend_offers`
--

INSERT INTO `lend_offers` (`id`, `type`, `coin_id`, `code`, `wallet`, `min`, `max`, `user_id`, `rate`, `percent`, `mintime`, `maxtime`, `country`, `account`, `note`, `expire`, `status`, `created_at`, `updated_at`) VALUES
(1, NULL, 2, '14SXNCJ7XNRM', 'RHc4nPK3424DPnGF73hFo4', '0.100', '0.600000', 16, '450', '12', 1, 4, '6', NULL, 'NO Scam', NULL, 1, '2021-06-29 10:01:58', '2021-06-29 10:39:33'),
(2, NULL, 2, 'A7GX8CX2M9EG', '214523412qwfqwfqwfqwfw', '0.100', '1', 16, '490', '11', 1, 6, '6', NULL, 'NO scam', NULL, 1, '2021-06-29 11:42:25', '2021-06-29 11:42:25'),
(3, NULL, 6, 'WXWAKA5UC1PW', '12345wewqeqqw', '0.100', '10', 16, '10', '12', 1, 5, '87', NULL, 'No Scam', NULL, 1, '2021-06-29 13:35:49', '2021-06-29 13:35:49');

-- --------------------------------------------------------

--
-- Table structure for table `lend_offers_trade`
--

CREATE TABLE `lend_offers_trade` (
  `id` bigint(20) UNSIGNED NOT NULL,
  `user_id` int(11) DEFAULT NULL,
  `wallet` varchar(88) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `coin` varchar(191) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  ...
  `loanreturn` varchar(30) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `marketcode` varchar(55) COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `trx` longtext COLLATE utf8mb4_unicode_ci DEFAULT NULL,
  `status` tinyint(4) NOT NULL DEFAULT 0,
  `escrowwallet` text COLLATE utf8mb4_unicode_ci DEFAULT NULL,
...
--
-- Dumping data for table `lend_offers_trade`
--

INSERT INTO `lend_offers_trade` (`id`, `user_id`, `wallet`, `coin`, `amount`, `duration`, `units`, `interest`, `loanreturn`, `marketcode`, `trx`, `status`, `escrowwallet`, `escrowid`, `escrowvalue`, `escrowusd`, `escrowpay`, `escrowfee`, `buyer`, `paid`, `disbursed`, `dispute`, `expire`, `created_at`, `updated_at`) VALUES
(1, 16, 'RHc4nPK3424DPnGF73hFo4VNMA1krMBib4', '6', '2', 4, '0.20200000', NULL, NULL, 'WXWAKA5UC1PW', 'EY4WT3HZSQDN', 0, 'RHP8rXVKBnwePb1p27LWzrdZRdYEmBZZro', 'TCN2358', '0.20200000', '0.20200000', '0.19998', '0.00202', 16, 0, 0, 0, '2021-06-29 17:37:24', '2021-06-29 14:37:24', '2021-06-29 14:37:24'),
(2, 16, '33K4a9wJG7hrBRHV314AJumsF2o4jKoXLm', '6', '50', 4, '5.05000000', NULL, '5.6', 'WXWAKA5UC1PW', 'HPBDC34TK8TK', 0, 'RR9gagqAPoFJw4zsBZ4gT1j2uTxmTBJje5', 'TCN2359', '5.05000000', '5.05000000', '4.9995', '0.0505', 16, 0, 0, 0, '2021-06-29 17:43:36', '2021-06-29 14:43:36', '2021-06-29 14:43:36'),
(3, 16, '33K4a9wJG7hrBRHV314AJumsF2o4jKoXLm', '6', '50', 4, '5.05000000', NULL, '5.6', 'WXWAKA5UC1PW', 'HZOVO8NZDAGA', 0, 'RExfM1V8SSNTZpPMrH6AYahSDDA2AA4mry', 'TCN2360', '5.05000000', '5.05000000', '4.9995', '0.0505', 16, 0, 0, 0, '2021-06-29 17:44:57', '2021-06-29 14:44:57', '2021-06-29 14:44:57'),
(4, 16, 'RHc4nPK3424DPnGF73hFo4VNMA1krMBib4', '6', '12', 4, '1.21200000', NULL, '1.344', 'WXWAKA5UC1PW', 'H4GBMEAGDRU7', 2, 'RC9xGNtuVHaKjGgBd4q5PrHixN3SzeCvUo', 'TCN2361', '1.21200000', '1.21200000', '1.19988', '0.01212', 16, 1, 0, 0, '2021-06-29 18:35:53', '2021-06-29 15:35:53', '2021-06-29 16:18:00');
...
(159, 16, '::1', '', 'Chrome', 'Mac OS X', NULL, NULL, NULL, NULL, '2021-06-29 22:14:16', '2021-06-29 22:14:16');
...
--
-- Indexes for table `lend_offers`
--
ALTER TABLE `lend_offers`
  ADD PRIMARY KEY (`id`);

--
-- Indexes for table `lend_offers_trade`
--
ALTER TABLE `lend_offers_trade`
  ADD PRIMARY KEY (`id`);
...
--
-- AUTO_INCREMENT for table `lend_offers`
--
ALTER TABLE `lend_offers`
  MODIFY `id` bigint(20) UNSIGNED NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT for table `lend_offers_trade`
--
ALTER TABLE `lend_offers_trade`
