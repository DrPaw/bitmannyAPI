            ...
            <ul class="navbar_search_result"></ul>
				...
				<aside class="app-sidebar toggle-sidebar" style="background-color: {{$general->bclr}}">
					...
					<ul class="side-menu toggle-menu">
						...
						<li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="#"><span class="icon-menu-img"><img src="{{url('/')}}/back/images/svgs/app.svg" class="side_menu_img svg-1" alt="image"></span><span class="side-menu__label">Crypto Sell Offer</span><i class="angle fa fa-angle-right"></i></a>
							<ul class="slide-menu">
								<li><a href="{{ route('admin.all.offer') }}" class="slide-item">All Sell Offers</a></li>
						...
						<li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="#"><span class="icon-menu-img"><img src="{{url('/')}}/back/images/svgs/app.svg" class="side_menu_img svg-1" alt="image"></span><span class="side-menu__label">Crypto Buy Offer</span><i class="angle fa fa-angle-right"></i></a>
							<ul class="slide-menu">
								<li><a href="{{ route('admin.all.offerbuy') }}" class="slide-item">All Buy Offers</a></li>
								<li><a href="{{ route('admin.successful.offer') }}" class="slide-item">Completed Trade</a></li>
								<li><a href="{{ route('admin.awaiting.offer') }}" class="slide-item">Trades Awaiting Admin Approval</a></li>
								<li><a href="{{ route('admin.pending.offer') }}" class="slide-item">Pending Trade</a></li>
								<li><a href="{{ route('admin.declined.offer') }}" class="slide-item">Disputed Trades</a></li>
						...
						<li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="#"><span class="icon-menu-img"><img src="{{url('/')}}/back/images/svgs/bars-graphic.svg" class="side_menu_img svg-1" alt="image"></span><span class="side-menu__label">Coin Lending</span><i class="angle fa fa-angle-right"></i></a>
							<ul class="slide-menu">
								<li><a href="{{ route('admin.pendingloan') }}" class="slide-item">Pending Loan</a></li>
								<li><a href="" class="slide-item">Running Loan</a></li>
								<li><a href="" class="slide-item">Closed Loan</a></li>

							</ul>
						</li>
						<li class="slide">
							<a class="side-menu__item" data-toggle="slide" href="#"><span class="icon-menu-img"><img src="{{url('/')}}/back/images/svgs/bars-graphic.svg" class="side_menu_img svg-1" alt="image"></span><span class="side-menu__label">HODL Manager</span><i class="angle fa fa-angle-right"></i></a>
							<ul class="slide-menu">
								<li><a href="{{ route('admin.hodl-setting') }}" class="slide-item">Create HODL Plan</a></li>
								<li><a href="{{ route('admin.hodl-running') }}" class="slide-item">Running Plans</a></li>
								<li><a href="{{ route('admin.hodl-closed') }}" class="slide-item">Closed Plans</a></li>
						...
						<li class="slide">
							<a href="{{ route('admin.setting.language-manage') }}" class="side-menu__item"><span class="icon-menu-img"><img src="{{url('/')}}/back/images/svgs/writing.svg" class="side_menu_img svg-1" alt="image"></span><span class="side-menu__label">Language Settings</span></a>
