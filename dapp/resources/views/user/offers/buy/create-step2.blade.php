							...
							<div class="col-xl-12">
								<div class="banner banner-color mt-0">
									...
									<div class="col-xl-3 col-lg-3 col-md-3 text-right d-flex d-block">
										...
										<a href="{{route('user.createbuyoffer')}}" class="btn btn-primary">Cancel Process</a>
									</div>
								</div>
							</div>
						</div>
						...
						<div class="row">
							<div class="col-lg-12">
								<div class="card accordion-wizard">
									...
									<div class="card-body">
									<form  id="form" class="contact-form" action="{{route('user.postofferbuy',$crypto->id)}}" method="post" enctype="multipart/form-data">
                                    @csrf

											<div class="list-group">
												<div class="list-group-item py-3" data-acc-step>
													<h5 class="mb-0" data-acc-title>Enter Amount</h5>
													<div data-acc-content>
														<div class="my-3">
														<div class="row">
															<div class="form-group col-12">
																<label>Coin:</label>
																<input type="text" value="{{$crypto->name}}" readonly placeholder="0.00"class="form-control" />
															</div>
														</div>

                                                        <div class="row">
															<div class="form-group col-12">
																<label>Amounr: <smaal>USD</small></label>
...
function myFunction() {
 var name = $("#curr option:selected").attr('data-name');
  document.getElementById("curname").innerHTML = "Your Rate 1USD to "+name;
																...
																<label>Select Your Payment Currency:</label>
															...
															<div class="form-group">
																<label><a id="curname">Enter You Buying Rate: </a></label>
...
function myFunction3() {
 var name = $("#pmeth option:selected").attr('data-name');
  document.getElementById("pname").innerHTML = "Enter your "+name+" details";
															...
															<div class="form-group">
																<label id="pname">Enter Your {{$crypto->name}} Wallet Address</label>
																<input type="text" name="wallet" placeholder="{{$crypto->name}} Address" class="form-control">
															</div>
															<div class="form-group">
																<label id="pname">Confirm Your {{$crypto->name}} Wallet Address</label>
																<input type="text" name="confirm_wallet" placeholder="Confirm {{$crypto->name}} Address" class="form-control">
															</div>
															<div class="form-group">
																<label>Enter Note To Seller</label>
																<textarea type="text" name="note" placeholder="A small note or message to sellers" class="form-control"></textarea>
															</div>
