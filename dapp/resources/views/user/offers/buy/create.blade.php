												...
												<tbody>
												 @foreach($crypto as $data)
													<tr>
														...
														<td>
															<a href="{{route('user.createoffer2buy',$data->symbol)}}" class="btn btn-info btn-sm text-white" data-toggle="tooltip" data-original-title="Select Cryptocurrency"><i class="fa fa-check-o"></i>Select</a>
														</td>
													</tr>
												 @endforeach
